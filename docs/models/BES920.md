...
|---|---|---|---|---|
| **ULKA pump** | Series 04 (04, 04.9) | ~1.1–1.3 MΩ pin-to-pin *(field-verified, 240V AU vibratory pump)* | 240V AC | Hum without flow = blocked or seized. No hum = relay/PCB or wiring fault |
| **Brew 3-way solenoid valve** | Series 03 (03.x) | ~2.2–2.5 kΩ (coil) *(field-verified, 240V AU)* | 240V AC | Test coil resistance across terminals. Mechanically stuck = no back-flush after shot |
| **Brew boiler heating element** | Series 03 (03.1–03.49) | 30–80 Ω | 240V AC | Infinite resistance = open circuit / failed element. Check element seal for leaks too |
| **Steam boiler heating element** | Series 05 (05, 05.4–05.25) | 30–80 Ω | 240V AC | Same test as brew element. Failure usually presents as no steam / weak steam |
...
| **Thermal fuse — brew boiler** | Series 03 (near element) | 0 Ω (continuity) | One-shot, 240V AC | Blown fuse (OL/infinite) = open circuit. Non-resettable. Indicates prior overtemp event — find root cause |
| **Thermal fuse — steam boiler** | Series 05 (near element) | 0 Ω (continuity) | One-shot, 240V AC | Same as above. Both boilers have independent fuses |
