...
|---|---|---|---|---|
| **ULKA pump** | Series 04 (04, 04.9) | 200–300 Ω | 240V AC | Hum without flow = blocked or seized. No hum = relay/PCB or wiring fault |
| **Brew 3-way solenoid valve** | Series 03 (03.x) | 200–400 Ω (coil) | 240V AC | Test coil resistance across terminals. Mechanically stuck = no back-flush after shot |
...
- Test pump coil resistance (200–300 Ω expected)
